...
This experiment was created using PsychoPy3 Experiment Builder (v2020.2.10),
    on Tue 08 Feb 2022 11:06:16 PM PST
...
for thisPractice_trial in practice_trials:
    ...
    # keep track of which components have finished
    hand_resetComponents = [reset_image, feedback_2]
...
for thisTrial_1 in trials_1:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if text_1.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_1.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if key_resp_1.status == STARTED and not waitOnFlip:
            ...
            if len(_key_resp_1_allKeys):
                ...
                # was this correct?
                if (key_resp_1.keys == str(corrAns1)) or (key_resp_1.keys == corrAns1):
                    key_resp_1.corr = 1
                else:
                    key_resp_1.corr = 0
