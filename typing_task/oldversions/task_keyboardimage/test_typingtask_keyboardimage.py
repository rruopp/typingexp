...
expName = 'test_typingtask_keyboardimage'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/greenhouselab/Documents/Rubi/typing_task_V2/test_typingtask_keyboardimage.py',
...
for thisTrial in trials:
    ...
    for thisComponent in hand_resetComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials.addData('reset_image.started', reset_image.tStartRefresh)
    trials.addData('reset_image.stopped', reset_image.tStopRefresh)
    thisExp.nextEntry()
...
trials_2 = data.TrialHandler(nReps=5, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('typingtask_variables_V2.xls'),
